...
data modify entity @n[type=block_display,tag=red_spawnpoint] transformation.left_rotation set value [0f,1f,0f,0f]
...
data modify storage bcm macro.x set string entity @n[type=marker,tag=red_spawnpoint] Pos[0] 0 -1
data modify storage bcm macro.y set string entity @n[type=marker,tag=red_spawnpoint] Pos[1] 0 -1
data modify storage bcm macro.z set string entity @n[type=marker,tag=red_spawnpoint] Pos[2] 0 -1
data modify storage bcm macro.yaw set string entity @n[type=marker,tag=red_spawnpoint] Rotation[0] 0 -1
data modify storage bcm macro.pitch set string entity @n[type=marker,tag=red_spawnpoint] Rotation[1] 0 -1
