...
# moved layer?
execute if score .gate_opening .calc matches 1 if score .current_time .calc matches 1 if score .current_height .calc <= .height .calc if score .current_height .calc matches 1.. run function game:gate/editor/up
execute if score .gate_opening .calc matches 0 if score .current_time .calc matches 1 if score .current_height .calc <= .height .calc if score .current_height .calc matches 1.. run function game:gate/editor/down
