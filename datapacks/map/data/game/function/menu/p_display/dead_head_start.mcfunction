...
execute as @a[tag=me_player,tag=locked_63] at @s run scoreboard players add @s track_shot_head 1
execute as @a[tag=me_player,tag=locked_63,scores={track_shot_head=5..}] at @s run function game:player/unlock/63
