...
execute as @e[type=pig,tag=!turret,tag=!chair,tag=!balloon] at @s run function game:ffa/turret/spawn
...
execute as @e[type=pig,tag=turret,tag=!chair,tag=!balloon] at @s run function game:ffa/turret/display
