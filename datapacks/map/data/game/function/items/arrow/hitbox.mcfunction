...
execute as @s[scores={t1=2..10}] if entity @p[tag=in_hitbox,tag=enemy_player] as @p[tag=id_share] at @s run playsound minecraft:entity.arrow.hit_player master @s ~ ~ ~ 0.2 0
execute as @s[scores={t1=2..10}] if entity @p[tag=in_hitbox,tag=enemy_player,tag=!totem] run tag @p[tag=in_hitbox,tag=enemy_player,tag=!totem] add close_hit
execute as @s[scores={t1=2..10}] as @p[tag=in_hitbox,tag=enemy_player] run damage @s 1 arrow by @p[tag=id_share]

execute as @s[scores={t1=2..10},tag=!kill,tag=!inground] run damage @e[tag=in_hitbox,type=zombie_villager,limit=1,sort=nearest] 1000
...
#execute as @s[scores={t1=2..8},tag=!kill,tag=!inground] run particle minecraft:dripping_obsidian_tear ~0.25 ~0.5 ~-0.25 0 0 0 0 1 force
#execute as @s[scores={t1=2..8},tag=!kill,tag=!inground] run particle minecraft:dripping_obsidian_tear ~-0.25 ~0.5 ~0.25 0 0 0 0 1 force
#execute as @s[scores={t1=2..8},tag=!kill,tag=!inground] run patnecraft:dripping_obsidian_tear ~0.25 ~0.5 ~0.25 0 0 0 0 1 force