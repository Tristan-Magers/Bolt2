...
execute as @s[scores={ID=1..},tag=glitter] unless entity @e[type=snowball,tag=id_share,scores={ID.item=0}] run summon armor_stand ~ ~-1.6 ~ {Tags:["grenadehit","new_ger_hit","glitter"],Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:white_stained_glass",count:1}]}
