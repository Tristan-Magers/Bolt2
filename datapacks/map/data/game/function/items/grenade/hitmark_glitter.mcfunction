...
execute as @s[scores={timer=5..}] at @s positioned ~ ~0.75 ~ run scoreboard players set @a[distance=..4.8,gamemode=adventure] blind 45
execute as @s[scores={timer=5..}] at @s positioned ~ ~1.25 ~ run scoreboard players set @a[distance=..4.8,gamemode=adventure] blind 45

execute as @s[scores={timer=5..}] at @s positioned ~ ~0.75 ~ run scoreboard players set @e[distance=..4.8,tag=turret] blind 45
execute as @s[scores={timer=5..}] at @s positioned ~ ~1.25 ~ run scoreboard players set @e[distance=..4.8,tag=turret] blind 45
...
execute as @a[scores={blind=45,invul=..0}] at @s run playsound minecraft:entity.breeze.jump master @a ~ ~ ~ 0.3 1.4
execute as @a[scores={blind=45,invul=..0}] at @s run playsound minecraft:block.sand.break master @a ~ ~ ~ 1 0
execute as @a[scores={blind=45,invul=..0}] at @s run playsound minecraft:entity.breeze.hurt master @s ~ ~ ~ 0.05 1.8

execute as @a[scores={blind=45},tag=lobby] at @s run playsound minecraft:entity.breeze.jump master @a ~ ~ ~ 0.3 1.4
execute as @a[scores={blind=45},tag=lobby] at @s run playsound minecraft:block.sand.break master @a ~ ~ ~ 1 0
execute as @a[scores={blind=45},tag=lobby] at @s run playsound minecraft:entity.breeze.hurt master @s ~ ~ ~ 0.05 1.8
