...
execute as @s[scores={timer=17}] if entity @a[distance=..4.8] run execute as @a[gamemode=adventure,distance=..4.8,scores={respawn=..0,invul=..0},team=blue,tag=!killed,tag=!gre_immune,tag=hasflag] at @s if entity @e[type=armor_stand,tag=flag,team=blue,distance=..8] if score .mode .data matches 1 if score .tmi .data matches 0 as @a[tag=id_share,team=red,tag=locked_17] run function game:player/unlock/17
execute as @s[scores={timer=17}] if entity @a[distance=..4.8] run execute as @a[gamemode=adventure,distance=..4.8,scores={respawn=..0,invul=..0},team=red,tag=!killed,tag=!gre_immune,tag=hasflag] at @s if entity @e[type=armor_stand,tag=flag,team=red,distance=..8] if score .mode .data matches 1 if score .tmi .data matches 0 as @a[tag=id_share,team=blue,tag=locked_17] run function game:player/unlock/17
