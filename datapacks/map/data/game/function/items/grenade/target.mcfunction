...
execute as @s at @s positioned ~ ~0.6 ~ run scoreboard players operation @a[tag=id_share] kill += @s t5
execute as @s at @s positioned ~ ~0.6 ~ run scoreboard players operation @a[tag=id_share] Scores += @s t5
...
execute as @s[scores={t5=1..}] as @a[tag=id_share] at @s run playsound minecraft:entity.arrow.hit_player master @s ~ ~ ~ 0.8 0.8
execute as @s[scores={t5=1..}] as @a[tag=id_share] at @s run playsound minecraft:block.grass.break master @s ~ ~ ~ 1 0.5
execute as @s[scores={t5=1..}] as @a[tag=id_share] at @s run playsound minecraft:block.grass.break master @s ~ ~ ~ 1 1.2
