...
execute as @a store result score @s trapCount run clear @s minecraft:panda_spawn_egg[custom_model_data=0] 0
execute as @a store result score @s wallCount run clear @s minecraft:panda_spawn_egg[custom_model_data=1] 0
execute as @a store result score @s magmaCount run clear @s minecraft:panda_spawn_egg[custom_model_data=2] 0
execute as @a store result score @s slimeCount run clear @s minecraft:panda_spawn_egg[custom_model_data=3] 0
execute as @a store result score @s turretCount run clear @s minecraft:panda_spawn_egg[custom_model_data=4] 0
