...
execute unless score .mode_screen .data = .6 .num if score .mode_screen .data = .1 .num run title @s[scores={team_pref=0,lobby_text_time=1}] actionbar {"text":"Selected Random Team (uses matchmaking)","color":"light_purple"}
