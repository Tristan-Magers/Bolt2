...
item replace entity @s[scores={blind=18}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_90"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=17}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_85"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=16}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_80"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=15}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_75"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=14}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_70"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=13}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_65"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=12}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_60"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=11}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_55"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=10}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_50"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=9}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_45"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=8}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_40"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=7}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_35"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=6}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_30"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=5}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_25"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=4}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_20"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=3}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_15"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=2}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_10"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
item replace entity @s[scores={blind=1}] armor.head with minecraft:yellow_stained_glass_pane[equippable={slot:"head",camera_overlay:"block/blind_5"},enchantments={levels:{"minecraft:binding_curse":1}}] 1
