...
#item replace block 235 -49 -224 container.18 with purple_stained_glass_pane[custom_name='{"text":"Every _ Kills [1/3/5/7]","italic":false}',lore=['{"text":"These slots control items you have","italic":false}','{"text":"given at the start of the game.","italic":false}']]
