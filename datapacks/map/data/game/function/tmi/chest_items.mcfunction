...
clear @a[tag=lobby,nbt={Inventory:[{id:"minecraft:snowball",components:{"minecraft:custom_model_data":{strings:["0"]}}}]}] snowball[custom_model_data={strings:["0"]}]
...
execute if data block 235 -49 -224 {Items:[{Slot:26b,id:"minecraft:black_stained_glass_pane"}]} run item replace block 235 -49 -224 container.26 with air
