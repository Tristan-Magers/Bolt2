...
execute as @a[tag=lobby] if items entity @s player.cursor black_stained_glass_pane[custom_name='{"text":""}'] run tag @s add tmi_chest_clear
...
execute as @a[tag=lobby] if items entity @s hotbar.* black_stained_glass_pane[custom_name='{"text":""}'] run tag @s add tmi_chest_clear
...
execute as @a[tag=lobby] if items entity @s inventory.* black_stained_glass_pane[custom_name='{"text":""}'] run tag @s add tmi_chest_clear
