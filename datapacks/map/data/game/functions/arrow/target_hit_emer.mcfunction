...
execute as @a[scores={ID=0},distance=30..] at @s run title @s actionbar {"text":"SUPER SNIPER SHOT [+8]","color":"green"}
execute as @a[scores={ID=0},distance=30..] at @s run scoreboard players add @s Scores 6
