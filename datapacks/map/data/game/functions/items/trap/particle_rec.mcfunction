tp @s ~ ~ ~ ~4 0
execute as @s[team=red] run particle minecraft:wax_on ^ ^.1 ^3.7 0 0 0 0 1 force @a[team=red]
execute as @s[team=red] run particle minecraft:wax_off ^ ^.1 ^4.8 0 0 0 0 1 force @a[team=red]

execute as @s[team=blue] run particle minecraft:wax_on ^ ^.1 ^3.7 0 0 0 0 1 force @a[team=blue]
