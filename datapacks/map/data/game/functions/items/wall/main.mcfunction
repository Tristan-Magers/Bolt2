...
#height cap
execute as @s at @s positioned ~ 0 ~ if entity @s[distance=..50] unless score .map .data = .15 .num unless score .map .data = .14 .num unless score .map .data = .1 .num unless score .map .data = .13 .num unless score .map .data = .10 .num unless score .map .data = .9 .num unless score .map .data = .6 .num run scoreboard players set @s timer 30
