...
execute as @s[scores={t=3},tag=!rev] run summon minecraft:armor_stand ^2 ^2.06 ^5 {NoBasePlate:1b,Rotation:[240F,0F],Tags:["head","red"],NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,DisabledSlots:4144959,Small:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":{rgb:16711680,show_in_tooltip:false}}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":{rgb:16711680,show_in_tooltip:false}}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":{rgb:16711680,show_in_tooltip:false}}},{}]}
...
execute as @s[scores={t=3},tag=!rev] run summon minecraft:armor_stand ^-2 ^2.06 ^5 {NoBasePlate:1b,Rotation:[300F,0F],Tags:["head","blue"],NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,DisabledSlots:4144959,Small:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":{rgb:22015,show_in_tooltip:false}}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":{rgb:22015,show_in_tooltip:false}}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":{rgb:22015,show_in_tooltip:false}}},{}]}
