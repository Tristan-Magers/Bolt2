...
execute as @s[nbt=!{Inventory:[{id:"minecraft:magenta_glazed_terracotta",Slot:35b}]},tag=lobby,tag=has_bow_ui] run function game:bow_ui/next_page
execute as @s[nbt=!{Inventory:[{id:"minecraft:magenta_glazed_terracotta",Slot:34b}]},tag=lobby,tag=has_bow_ui] run function game:bow_ui/prev_page
