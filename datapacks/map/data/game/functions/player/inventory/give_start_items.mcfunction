...
execute if score .mode .data = .6 .num run give @s[scores={cutscene_time=0,cutscene=1},team=blue] panda_spawn_egg[custom_model_data=0,can_place_on={predicates:[{blocks:"#game:bolt_place"}]},custom_name='{"text":"Trap","italic":false,"color":"gray"}',EntityTag:{id:"minecraft:creeper",PersistenceRequired:1b,Silent:1b}] 2
#execute if score .mode .data = .6 .num run give @s[scores={cutscene_time=0,cutscene=1},team=blue] panda_spawn_egg{custom_model_data=4,can_place_on={predicates:[{blocks:"#game:bolt_place"}]},custom_name='{"text":"Turret","italic":false,"color":"gray"}'},EntityTag:{id:"minecraft:pig",PersistenceRequired:0b,Silent:1b,NoAI:1,IsBaby:0b,Health:10f}} 1
