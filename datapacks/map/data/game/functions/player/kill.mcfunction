...
# kill items
give @s[scores={killStreak=2},team=blue] panda_spawn_egg{CustomModelData:3,CanPlaceOn:["#game:bolt_place"],display:{Name:'{"text":"Spawn Point","italic":false,"color":"gray"}'},EntityTag:{id:"minecraft:slime",PersistenceRequired:1b,Silent:1b,Size:0},HideFlags:48} 1
give @s[scores={killStreak=2},team=red] panda_spawn_egg{CustomModelData:2,CanPlaceOn:["#game:bolt_place"],display:{Name:'{"text":"Spawn Point","italic":false,"color":"gray"}'},EntityTag:{id:"minecraft:magma_cube",PersistenceRequired:1b,Silent:1b,Size:0},HideFlags:48} 1

give @s[scores={killStreak=3}] panda_spawn_egg{CustomModelData:0,CanPlaceOn:["#game:bolt_place"],display:{Name:'{"text":"Trap","italic":false,"color":"gray"}'},EntityTag:{id:"minecraft:creeper",PersistenceRequired:1b,Silent:1b},HideFlags:48} 2
give @s[scores={killStreak=5}] map{display:{Name:'{"text":"Reveal","italic":false,"color":"gray"}'}} 1
give @s[scores={killStreak=7}] panda_spawn_egg{CustomModelData:0,CanPlaceOn:["#game:bolt_place"],display:{Name:'{"text":"Trap","italic":false,"color":"gray"}'},EntityTag:{id:"minecraft:creeper",PersistenceRequired:1b,Silent:1b},HideFlags:48} 2
...
execute if score .mode .data = .7 .num run give @s[scores={t=0,kills=..45}] crossbow{display:{Name:'{"text":"Crossbow (lasts 11 seconds)","italic":false,"color":"gray"}'},Enchantments:[{id:"minecraft:quick_charge",lvl:5s}]} 1
...
execute if score .mode .data = .7 .num run give @s[scores={t=0,kills=..45}] snowball{display:{Name:'{"text":"Grenade (can\'t break emerald)","italic":false,"color":"gray"}'}} 1
...
execute if score .mode .data = .7 .num run give @s[scores={t=0,kills=..45}] egg{display:{Name:'{"text":"Boost","italic":false,"color":"gray"}'}} 1

#
execute if score .mode .data = .7 .num run tellraw @s[scores={kills=45}] [{"text":"45 KILLS!!","color":"yellow"},{"text":" (No more items)","color":"gray"}]
