...
execute as @s at @s if entity @e[tag=spawn,scores={ID=0},limit=1] run scoreboard players set @s invul 18
execute as @s at @s if entity @e[tag=spawn,scores={ID=0},limit=1] run scoreboard players set @s removeBlind 14
execute as @s at @s if entity @e[tag=spawn,scores={ID=0},limit=1] run scoreboard players set @s arrowReload 26
execute as @s at @s if entity @e[tag=spawn,scores={ID=0},limit=1] run effect give @s blindness 1 20 true
execute as @s at @s if entity @e[tag=spawn,scores={ID=0},limit=1] run effect clear @s minecraft:invisibility
