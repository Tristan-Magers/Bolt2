...
#
execute as @s[tag=!kill,team=red] run summon armor_stand ~ ~-1.5 ~ {Marker:1,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:paper",Count:1b,tag:{custom_model_data=200}}],Tags:["turret_stand","red"]}
execute as @s[tag=!kill,team=red] run summon armor_stand ~ ~-.5 ~ {Marker:1,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:paper",Count:1b,tag:{custom_model_data=201}}],Tags:["turret_head","red"]}

execute as @s[tag=!kill,team=blue] run summon armor_stand ~ ~-1.5 ~ {Marker:1,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:paper",Count:1b,tag:{custom_model_data=210}}],Tags:["turret_stand","blue"]}
execute as @s[tag=!kill,team=blue] run summon armor_stand ~ ~-.5 ~ {Marker:1,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:paper",Count:1b,tag:{custom_model_data=211}}],Tags:["turret_head","blue"]}
