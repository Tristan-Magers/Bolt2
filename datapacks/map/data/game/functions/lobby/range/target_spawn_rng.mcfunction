...
execute at @s if entity @e[type=marker,tag=range_target,tag=!this,distance=..6] unless score .tries data matches 200.. run function game:lobby/range/target_spawn_rng
tag @s remove this