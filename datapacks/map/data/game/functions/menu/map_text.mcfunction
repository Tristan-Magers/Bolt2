...
execute if score .map_screen .data = .10 .num run title @a[tag=me_player] actionbar [{"text":""},{"text":"TINY TOWN","color":"#8AA1B5","bold":true},{"text":" | Size: "},{"text":"⬜⬜⬜","color":"#29AEF0","bold":true}]