...
execute if score .map_screen .data = .12 .num run title @a[tag=me_player] actionbar [{"text":""},{"text":"GARDEN","color":"#63B560","bold":true},{"text":" | Size: "},{"text":"⬛⬛⬛","color":"#F02B24","bold":true}]
...
execute if score .map_screen .data = .14 .num run title @a[tag=me_player] actionbar [{"text":""},{"text":"RIVER","color":"#CFAE91","bold":true},{"text":" | Size: "},{"text":"⬛⬛⬛","color":"#F02B24","bold":true}]
...
execute if score .map_screen .data = .15 .num run title @a[tag=me_player] actionbar [{"text":""},{"text":"LIGHTHOUSE","color":"#8AA1B5","bold":true},{"text":" | Size: "},{"text":"⬛⬜⬜","color":"#29AEF0","bold":true}]