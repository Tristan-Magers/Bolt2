...
execute if entity @s[x=259.5,y=-55,z=-245.5,dx=5,dy=-1,dz=20,scores={timer=..150}] if score .start_cd .data >= .0 .num run title @a title {"text":"Start Canceled","color":"gray"}
execute if entity @s[x=259.5,y=-55,z=-245.5,dx=5,dy=-1,dz=20,scores={timer=..150}] if score .start_cd .data >= .0 .num run scoreboard players set .start_cd .data -5
execute if entity @s[x=259.5,y=-55,z=-245.5,dx=5,dy=-1,dz=20,scores={timer=..150}] unless score .start_cd .data >= .0 .num unless score .start_cd .data = .n5 .num run scoreboard players set .start_cd .data 62
