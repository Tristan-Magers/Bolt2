...
execute if score .map3 .custom_random matches 1 run item replace block 235 -49 -226 container.2 with lime_dye[custom_name='[{"text":"Hex [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map4 .custom_random matches 1 run item replace block 235 -49 -226 container.3 with lime_dye[custom_name='[{"text":"Coves [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map5 .custom_random matches 1 run item replace block 235 -49 -226 container.4 with lime_dye[custom_name='[{"text":"Lighthouse [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map6 .custom_random matches 1 run item replace block 235 -49 -226 container.5 with lime_dye[custom_name='[{"text":"Towers [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map7 .custom_random matches 1 run item replace block 235 -49 -226 container.6 with lime_dye[custom_name='[{"text":"Garden [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map8 .custom_random matches 1 run item replace block 235 -49 -226 container.7 with lime_dye[custom_name='[{"text":"River [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
execute if score .map9 .custom_random matches 1 run item replace block 235 -49 -226 container.8 with lime_dye[custom_name='[{"text":"Valley [","italic":false},{"text":"ENABLED","italic":false,"color":green},{"text":"]","italic":false}]']
...
execute if score .map3 .custom_random matches 0 run item replace block 235 -49 -226 container.2 with brown_dye[custom_name='[{"text":"Hex [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map4 .custom_random matches 0 run item replace block 235 -49 -226 container.3 with brown_dye[custom_name='[{"text":"Coves [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map5 .custom_random matches 0 run item replace block 235 -49 -226 container.4 with brown_dye[custom_name='[{"text":"Lighthouse [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map6 .custom_random matches 0 run item replace block 235 -49 -226 container.5 with brown_dye[custom_name='[{"text":"Towers [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map7 .custom_random matches 0 run item replace block 235 -49 -226 container.6 with brown_dye[custom_name='[{"text":"Garden [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map8 .custom_random matches 0 run item replace block 235 -49 -226 container.7 with brown_dye[custom_name='[{"text":"River [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
execute if score .map9 .custom_random matches 0 run item replace block 235 -49 -226 container.8 with brown_dye[custom_name='[{"text":"Valley [","italic":false},{"text":"DISABLED","italic":false,"color":red},{"text":"]","italic":false}]']
