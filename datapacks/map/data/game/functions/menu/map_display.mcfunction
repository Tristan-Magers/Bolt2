...
execute if score .map_display .data = .3 .num run scoreboard players set .map_screen .data 2
execute if score .map_display .data = .4 .num run scoreboard players set .map_screen .data 15
execute if score .map_display .data = .5 .num run scoreboard players set .map_screen .data 1
execute if score .map_display .data = .6 .num run scoreboard players set .map_screen .data 12
execute if score .map_display .data = .7 .num run scoreboard players set .map_screen .data 14
execute if score .map_display .data = .8 .num run scoreboard players set .map_screen .data 6
execute if score .map_display .data = .9 .num run scoreboard players set .map_screen .data 10
