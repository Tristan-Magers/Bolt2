item replace block 235 -49 -223 container.10 with panda_spawn_egg[custom_model_data=1,can_place_on={predicates:[{blocks:"#game:bolt_place"}],show_in_tooltip:false},custom_name='{"text":"Walls","color":"gray","italic":false}',lore=['{"text":"Four blocks of breakable gravel","color":"white","italic":false}'],entity_data={id:"minecraft:silverfish",Silent:1b,NoAI:1}] 8
item replace block 235 -49 -223 container.11 with panda_spawn_egg[custom_model_data=0,can_place_on={predicates:[{blocks:"#game:bolt_place"}],show_in_tooltip:false},custom_name='{"text":"Trap","italic":false,"color":"gray"}',entity_data={id:"minecraft:creeper",PersistenceRequired:1b,Silent:1b}] 4
item replace block 235 -49 -223 container.12 with snowball[custom_name='{"text":"Grenade","italic":false,"color":"gray"}'] 4
item replace block 235 -49 -223 container.13 with panda_spawn_egg[custom_model_data=3,can_place_on={predicates:[{blocks:"#game:bolt_place"}],show_in_tooltip:false},custom_name='{"text":"Spawn Point","italic":false,"color":"gray"}',entity_data={id:"minecraft:slime",PersistenceRequired:1b,Silent:1b,Size:0}] 2
...
item replace block 235 -49 -223 container.16 with iron_ingot[custom_name='{"text":"Armor","color":"gray","italic":false}',lore=['{"text":"Survive one arrow hit","color":"white","italic":false}','{"text":"Doesn\'t block explosions","color":"white","italic":false}','{"text":"Drops the flag","color":"white","italic":false}']] 1
...
item replace block 235 -49 -223 container.0 with black_stained_glass_pane[custom_name='{"text":""}']
...
item replace block 235 -49 -223 container.17 with black_stained_glass_pane[custom_name='{"text":""}']
item replace block 235 -49 -223 container.18 with black_stained_glass_pane[custom_name='{"text":""}']
item replace block 235 -49 -223 container.19 with black_stained_glass_pane[custom_name='{"text":""}']

item replace block 235 -49 -223 container.25 with black_stained_glass_pane[custom_name='{"text":""}']
item replace block 235 -49 -223 container.26 with black_stained_glass_pane[custom_name='{"text":""}']
