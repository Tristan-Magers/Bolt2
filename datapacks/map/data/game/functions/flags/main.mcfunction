...
execute at @s positioned ~-1 ~ ~-1 as @s[tag=redflag,tag=flag] if entity @a[gamemode=adventure,team=blue,distance=..10,dx=1,dy=1.5,dz=1] run title @a subtitle {"text":"+5 Seconds","color":"white"}
execute at @s positioned ~-1 ~ ~-1 as @s[tag=redflag,tag=flag] if entity @a[gamemode=adventure,team=blue,distance=..10,dx=1,dy=1.5,dz=1] run title @a title {"text":"Red Flag Taken!","color":"red"}
...
execute at @s positioned ~-1 ~ ~-1 as @s[tag=blueflag,tag=flag] if entity @a[gamemode=adventure,team=red,distance=..10,dx=1,dy=1.5,dz=1] run title @a subtitle {"text":"+5 Seconds","color":"white"}
...
execute at @s positioned ~-1 ~ ~-1 as @s[tag=redflag] if entity @a[gamemode=adventure,team=red,distance=..10,dx=1,dy=1.5,dz=1,tag=hasflag] run title @a subtitle {"text":"+15 Seconds","color":"white"}
...
execute at @s positioned ~-1 ~ ~-1 as @s[tag=blueflag] if entity @a[gamemode=adventure,team=blue,distance=..10,dx=1,dy=1.5,dz=1,tag=hasflag] run give @a[team=blue,distance=..10,dx=1,dy=1.5,dz=1,tag=hasflag] iron_ingot{display:{Name:'{"text":"Survive one arrow hit","italic":false}'}} 1
...
execute at @s positioned ~-1 ~ ~-1 as @s[tag=blueflag] if entity @a[gamemode=adventure,team=blue,distance=..10,dx=1,dy=1.5,dz=1,tag=hasflag] run title @a subtitle {"text":"+15 Seconds","color":"white"}
execute at @s positioned ~-1 ~ ~-1 as @s[tag=blueflag] if entity @a[gamemode=adventure,team=blue,distance=..10,dx=1,dy=1.5,dz=1,tag=hasflag] run title @a title {"text":"BLUE SCORES!","color":"aqua"}
...
execute if entity @a[gamemode=adventure,team=blue,tag=hasflag] run bossbar set minecraft:status name {"text":"Red Flag Taken!!!","color":"red"}
