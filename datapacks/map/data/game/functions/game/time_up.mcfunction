...
execute if score .tmi .data matches 1 if score .time_mod .calc matches 0 run loot give @a[tag=playing] mine 221 -50 -244 air{drop_contents:1b}

scoreboard players operation .time_mod .calc = .Time .metric
scoreboard players operation .time_mod .calc %= .400 .num

execute if score .tmi .data matches 1 if score .time_mod .calc matches 0 run loot give @a[tag=playing] mine 221 -50 -242 air{drop_contents:1b}

scoreboard players operation .time_mod .calc = .Time .metric
scoreboard players operation .time_mod .calc %= .240 .num

execute if score .tmi .data matches 1 if score .time_mod .calc matches 0 run loot give @a[tag=playing] mine 221 -50 -240 air{drop_contents:1b}
