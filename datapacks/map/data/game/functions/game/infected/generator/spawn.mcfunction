...
execute align xyz run summon shulker ~0.5 ~ ~0.5 {CustomNameVisible:1b,CustomName:'{"text":"Generator"}',Invulnerable:1b,Glowing:0b,NoAI:1b,AttachFace:0b,active_effects:[{Id:11,Amplifier:10b,Duration:999999},{Id:14,Amplifier:10b,Duration:19999980,ShowParticles:0b},{Id:24,Amplifier:10b,Duration:999999}]}
